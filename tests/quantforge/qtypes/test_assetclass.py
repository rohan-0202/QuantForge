...
class TestAssetClass:
    def test_assetclass_enum_values(self):
    ...
    def test_assetclass_str_representation(self):
    ...
    def test_assetclass_repr_representation(self):
