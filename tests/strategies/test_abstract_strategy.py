...
from quantforge.strategies.abstract_strategy import SimpleTickerDataStrategy, StrategyInputData
...
class TestSimpleTickerDataStrategy:
    ...
    def test_generate_no_signal_flat(self, strategy, apple_stock, sample_ticker_data_flat):
    ...
    def test_generate_signals_multiple_items(self, strategy, apple_stock, microsoft_stock, sample_ticker_data_up, sample_ticker_data_down):
    ...
    def test_allocate_capital_insufficient_cash(self, strategy, apple_stock, next_day_prices):
    ...
    def test_allocate_capital_equal_allocation(self, strategy, apple_stock, microsoft_stock, next_day_prices):
        ...
        total_cost = (expected_apple_qty * apple_price) + (expected_msft_qty * msft_price)
        assert total_cost <= initial_cash

    def test_allocate_capital_missing_price_data(self, strategy, apple_stock, microsoft_stock, next_day_prices):
    ...
    def test_execute_buy_signals(self, strategy, apple_stock, next_day_prices):
        ...
        positions = strategy.portfolio._open_positions_by_tradeable_item.get(apple_stock, [])
    ...
    def test_execute_sell_signals(self, strategy, apple_stock, next_day_prices):
        ...
        position = strategy.portfolio.open_position(open_transaction)
    ...
    def test_execute_sell_signals_no_position(self, strategy, apple_stock, next_day_prices):
    ...
    def test_full_execute_cycle_buy(self, strategy, apple_stock, sample_ticker_data_up, next_day_prices):
    ...
    def test_full_execute_cycle_sell(self, strategy, apple_stock, sample_ticker_data_down, next_day_prices):
    ...
    def test_execute_missing_input_data_item(self, strategy, apple_stock, microsoft_stock, sample_ticker_data_up, next_day_prices):
    ...
    def test_execute_missing_required_data_type(self, strategy, apple_stock, next_day_prices):
